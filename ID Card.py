...
label_heading=canvas.create_text(180, 90, font=('Times', '24', 'bold italic'), text="Identity Card")
label_name_tag=canvas.create_text(40, 165, font=('Times', '18', 'bold italic'), text="Name:")
label_grade_tag=canvas.create_text(40, 205, font=('Times', '18', 'bold italic'), text="Grade:")
label_subject_tag=canvas.create_text(50, 250, font=('Times', '18', 'bold italic'), text="Subjects:")
